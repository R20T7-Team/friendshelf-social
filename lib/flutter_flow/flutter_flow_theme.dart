...
abstract class FlutterFlowTheme {
  ...
  late Color appBar;
  late Color dullOrange;
  late Color buttonBackground;
  late Color border;
  late Color orange;
  late Color bottomTabGrey;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF04113A);
  late Color secondary = const Color(0xFFC579FF);
  late Color tertiary = const Color(0xFF808080);
  late Color alternate = const Color(0xFFE7E0E0);
  ...
  late Color appBar = const Color(0xFFF6F6F6);
  late Color dullOrange = const Color(0xFFFFAC8C);
  late Color buttonBackground = const Color(0xFFEEEEEE);
  late Color border = const Color(0xFFCCCCCC);
  late Color orange = const Color(0xFFFF4700);
  late Color bottomTabGrey = const Color(0xFFA3A3A3);
  late Color customColor2 = const Color(0x2BCCCC33);
}
