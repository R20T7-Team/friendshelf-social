...
import 'create_step3_model.dart';
export 'create_step3_model.dart';
...
class CreateStep3Widget extends StatefulWidget {
  ...
  static String routeName = 'CreateStep3';
  static String routePath = 'createStep3';
...
class _CreateStep3WidgetState extends State<CreateStep3Widget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateStep3Model());
          ...
          child: Column(
            ...
            children: [
                                    ...
                                    child: Padding(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: !FFAppState()
                                            ...
                                            : () async {
                                                if (FFAppState()
                                                    ...
                                                    'Restaurants') {
                                                  context.pushNamed(
                                                      CreateStepRestaurantWidget
                                                          .routeName);
                                                } else {
                                                  context.pushNamed(
                                                    CreateStepOtherAllWidget
                                                        .routeName,
                                                    queryParameters: {
                                                      'thisRecommendation':
                                                          serializeParam(
                                        ...
                                        options: FFButtonOptions(
                                          ...
                                          disabledColor: Color(0xD004113A),
                                        ),
                                      ),
                                    ),
                                  ),
              ...
              Column(
                mainAxisSize: MainAxisSize.max,
                children: [
                  if (FFAppState().CreatingShelf.mainCategoryString ==
                      'Restaurants')
                    Align(
                      alignment: AlignmentDirectional(0.0, 0.0),
                      child: InkWell(
                              ...
                              return GestureDetector(
                                ...
                                child: Padding(
                                  ...
                                  child: Container(
                                    ...
                                    child: BottomSheetCreateS3Widget(),
                                  ),
                                ),
                              );
                            },
